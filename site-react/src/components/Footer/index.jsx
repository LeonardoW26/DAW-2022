            ...
            <div className="container">
                <div className="footer-content">
                    <div className="footer-company">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa reprehenderit, dolorum consequuntur
                            nam esse eum beatae iusto labore soluta porro reiciendis assumenda! Adipisci eum eligendi
                            nostrum praesentium itaque tempore. Consectetur.</p>
                    </div>
                    ...
                    <div className="footer-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Empresa do Nelson Mandela</a></li>
                        </ul>
                    </div>
